...
const MUSCLE_GROUPS = {
  ...
  biceps_left: {
    name: 'Left Bicep',
    color: '#44ff44',
    position: [0.32, 0.48, 0.04] as [number, number, number],
    scale: [0.08, 0.05, 0.03] as [number, number, number],
    rotation: [0, 0, 0] as [number, number, number],
    opacity: 0.5,
  },
  biceps_right: {
  ...
  shoulders_left: {
    name: 'Left Shoulder',
    color: '#4444ff',
    position: [0.28, 0.59, -0.06] as [number, number, number],
  ...
  abs: {
    name: 'Abs',
    color: '#ffff44',
    position: [-0.01, 0.29, 0.18] as [number, number, number],
    scale: [0.11, 0.18, 0.04] as [number, number, number],
    rotation: [0, 0, 0] as [number, number, number],
    opacity: 0.6,
  },
  back: {
    name: 'Back',
    color: '#ffb144ff',
    position: [0.00, 0.46, -0.15] as [number, number, number],
    scale: [0.15, 0.24, 0.04] as [number, number, number],
    rotation: [0, 0, 0] as [number, number, number],
    opacity: 0.6,
  },
  quads_left: {
    ...
    color: '#ff44ff',
    position: [0.15, -0.15, 0.15] as [number, number, number],
    scale: [0.08, 0.23, 0.05] as [number, number, number],
    rotation: [0, 0, 0] as [number, number, number],
    opacity: 0.6,
  },
  quads_right: {
  ...
  calves_left: {
    name: 'Left Calf',
    color: '#44ffff',
    position: [0.18, -0.57, -0.18] as [number, number, number],
    scale: [0.06, 0.15, 0.04] as [number, number, number],
    rotation: [0, 0, 0] as [number, number, number],
    opacity: 0.6,
  },
  calves_right: {
